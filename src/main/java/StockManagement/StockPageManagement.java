...
public class StockPageManagement extends BaseContainer {

	public StockPageManagement(WebDriver Driver) {
	...
	public void TakeScreenShot01(String FileName) {
		...
		try {
			FileUtils.copyFile(ScreenShot01,
					new File("/home/jordanliucmcraf/eclipse-workspace/Simplilearn-Assignment/Screenshots/" + FileName + ""));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
